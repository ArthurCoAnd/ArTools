  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(image: DecorationImage(image: AssetImage('assets/images/fundos/Brasil.jpg'), fit: BoxFit.cover)),
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Image.asset('assets/images/logos/MapaBrasil.png', height: 131, width: 131),
              ),
